...
namespace MATH {
	...
	class MMath {
	public:
		static Matrix4 rotate(const float degrees_, const float x_, 
							  const float y_, const float z_);
		...
		static Matrix4 perspective(const float fovy_, const float aspect_, 
